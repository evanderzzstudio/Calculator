...
function addClasses(button) {
    ...
    const btnClearClass = "hover: bg-orang-500 border-red-500";
    ...
    const baseClass =
        "numberflex w-12 h-12 justify-center items-center m-1 font-bold py-2 px-2 border hover:border-transparent rounded text-white border-2 text-2xl  ";
